...
While the App may interact with the Solana blockchain, which contains public, immutable data, the copyright in the App's interface, user experience, and proprietary algorithms that interpret blockchain or astrological data remains the sole property of wang kai.

## 5. Contact Information
For copyright inquiries or permission requests, please contact:  
wangkingqq@gmail.com
